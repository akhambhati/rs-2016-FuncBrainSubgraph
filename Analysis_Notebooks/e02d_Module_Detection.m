...
load ~/Remotes/RSRCH.NMF_Subnetworks/e02d-DynFuncModule-Population/Module_Optimization.AdjMatr.mat
...
save('~/Remotes/RSRCH.NMF_Subnetworks/e02d-DynFuncModule-Population/Module_Optimization.ModMat_Full.mat', ...
...
for seed=1:100
    load ~/Remotes/RSRCH.NMF_Subnetworks/e02d-DynFuncModule-Population/Module_Optimization.ModMat_Full.mat;
    fname = sprintf('~/Remotes/RSRCH.NMF_Subnetworks/e02d-DynFuncModule-Population/Module_Optimization.ModAssign.%d.mat', seed);
    disp(fname)
